...
> and [`READING_AND_PRACTICE.md`](READING_AND_PRACTICE.md) is what fills those hours. Note that the
> gap list below doubles as that plan's Phase 2 assignment list: the reader learns C1–C2, D1–D3 and E
> by writing them.
